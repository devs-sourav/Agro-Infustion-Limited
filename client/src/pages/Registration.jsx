    ...
    <div className="sm:h-screen">
      <div className="grid grid-cols-12 h-full">
        <div className="col-span-12 sm:col-span-7 h-full">
          <div className="w-36 h-36 sm:hidden mx-auto rounded-full flex justify-center items-center mt-6 bg-white">
          ...
          <div className="w-full h-full flex justify-center items-center">
            <div>
              ...
              <div className="max-w-[600px] text-center mx-auto">
                ...
                <p className="text-xl font-normal px-10 text-white mt-10 leading-[38px]">
                  Essential Products for Every Farmer's Need: Your Trusted

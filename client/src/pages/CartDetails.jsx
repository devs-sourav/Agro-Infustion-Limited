            ...
            <div className="w-full flex justify-between relative flex-wrap">
              <div className="w-full sm:w-[70%] mx-auto">
                        ...
                        {cartItems.map((item) => (
                          ...
                          >
                            ...
                            <td className="px-4 py-2">
                              <div className="flex justify-around items-center border w-2/3 p-2 rounded-md">
                                <span
                                  onClick={() =>
                                ...
                                <span className="w-10 h-6 text-center">
                                  {item.quantity}
                                </span>
                                <span
                                  onClick={() =>
                ...
                <div className="flex justify-between mt-5">
                  ...
                  <Link to="/checkout">
                    <button className="mt-4 px-4 sm:px-8 py-2 bg-primary hover:bg-white text-white border hover:text-primary hover:border hover:border-primary rounded-lg">
                      Proceed to Checkout
                    </button>
                  </Link>
                </div>

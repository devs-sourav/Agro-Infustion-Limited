...
const OrderHistory = () => {
      ...
      <html>
        ...
        <body>
          ...
          <div class="order">
            ...
            <p><strong>Address:</strong> ${order.streetAddress}, ${order.area}, ${order.upazilla}, ${order.district}, ${order.postCode}</p>
  ...
  return (
    <div className="mt-5 bg-white sm:px-0 overflow-x-scroll w-full">

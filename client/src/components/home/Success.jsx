...
const Success = () => {
  ...
  return (
    <div className="font-robo relative">
      <div className="absolute left-0 -top-[50px] sm:-top-[100px]">
        <img className="w-[100px] sm:w-[160px]" src={leaves1} alt="Leaves" />
      </div>
      <Containar>
          ...
          >
            {stories?.doc?.map((storie) => (
              <SwiperSlide key={storie?._id}>
                <div className="flex flex-wrap cursor-pointer w-full items-center justify-between px-0 pt-10">
                  ...
                  <div
                    onClick={() => navigate(`/success-stories/${storie?._id}`)}
                    className="bg-[#F2F2F2] w-full sm:w-[49%] rounded-lg p-10 h-[220px] sm:h-[380px] relative"
                  >

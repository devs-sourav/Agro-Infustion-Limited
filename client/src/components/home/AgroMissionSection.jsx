  ...
  return (
    <div className="font-robo relative mb-10 hodden lg:block">
      <div className="absolute left-0 -top-[70px]">
        <img className="w-[100px] md:w-[160px]" src={leaves1} alt="Leaves Decoration"></img>
      </div>
      <div className="hidden md:inline-block absolute right-0 top-80 pt-6">
        <img src={team} alt="Team Background"></img>
      </div>
      <Containar>
        <div className="pb-[40px] sm:pb-[95px] pt-[115px] w-full">
          <div className="flex flex-col md:flex-row gap-y-10 md:gap-y-0 justify-between items-start w-full pb-10 md:pb-20 lg:pb-48">
            <div className="z-20 w-full md:w-3/5">
              <h6 className="text-primary font-bold text-[16px] md:text-xl mb-3 uppercase">
                Our Mission
              </h6>
              <h3 className="text-[22px] md:text-[40px] font-bold w-full md:w-5/6 leading-7 sm:leading-[58px]">
                Navigate the Future of Agriculture with Agro Infusion Limited
              </h3>
            </div>
            <div className="float-end flex flex-col items-center gap-10 -mt4 w-full md:w-2/5">
              <div className="flex gap-6 ">
                <div className="flex flex-col items-center">
                  ...
                  <h6 className="font-bold text-lg md:text-[18px]  xl:text-2xl my-8">
                    100% Organic
                  </h6>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <h6 className="font-bold text-lg md:text-[17px] xl:text-2xl my-8">
                    Premium Quality
                  </h6>
                  <p className="text-center text-sm">
                    Nisi eget venenatis felis posuere aptent aenean ipsum
          ...
          <div className="relative hidden xl:inline-block w-full">
            ...
            <div className="absolute -top-32 -left-8 flex text-white p-12 ps-24 z-50 h-full items-center">
            ...
            <div className="absolute bottom-[13%] right-[2%] xl:right-[3%] rounded-xl text-white grid grid-cols-3 items-center gap-y-5 md:gap-y-10 gap-x-6">
          ...
          {/* for small device */}
          <div className="relative w-full xl:hidden mt-10">
            <img
              src={bgImg2}
              alt=""
              className="w-full h-[360px] sm:h-[300px] object-cover rounded-2xl"
            />
            <div className="absolute top-0 left-0 right-0 bottom-0 rounded-xl text-white grid grid-cols-2 md:grid-cols-3 items-center gap-y-5 gap-x-6 p-4">
              <div className="text-center">
                <InViewCounter  end={13000} />
                <small className="text-base sm:text-lg font-normal">
                  Satisfied customer
                </small>
              </div>
              <div className="text-center">
                <InViewCounter end={26} />
                <small className="text-base sm:text-lg font-normal">Our Products</small>
              </div>
              <div className="text-center">
                <InViewCounter end={265} />
                <small className="text-base sm:text-lg font-normal">Our Dealership</small>
              </div>
              <div className="text-center">
                <InViewCounter end={1460} />
                <small className="text-base sm:text-lg font-normal">Our Team Members</small>
              </div>
              <div className="text-center">
                <InViewCounter end={3} />
                <small className="text-base sm:text-lg font-normal">

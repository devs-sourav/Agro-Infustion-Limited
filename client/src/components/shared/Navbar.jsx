      ...
      <Containar>
        <div className="py-4">
          <div className="flex justify-between items-center">
            <div>
              <div className="flex gap-x-3 items-center">
                <div className="w-[36px] sm:w-[56px]">
                  <Link to={"/"}>
                    <img className="w-full cursor-pointer" src={"https://i.ibb.co.com/b2qX9QH/logo.png"} alt="Logo" />
                  </Link>
                </div>
                <div>
                  <Link
                    to={"/"}
                    className="text-[14px] sm:text-[16px]  xl:text-[24px] font-bold text-white"
                  >
            ...
            <div className="hidden lg:flex items-center gap-x-5 xl:gap-x-10">
              <ul className="flex gap-x-5 lg:gap-x-8 items-center">
                {menulist.map((item, index) => (
                  <li key={index}>
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        isActive
                          ? "text-secondary text-[14px] xl:text-[17px] font-bold relative before:bg-secondary before:absolute before:contents-[] before:left-0 before:-bottom-3 before:w-full before:h-[2px]"
                          : "text-white text-[14px] xl:text-[17px] relative before:bg-secondary before:absolute before:contents-[] before:right-0 before:-bottom-3 before:w-[0px] hover:before:w-full before:h-[2px] font-bold hover:text-secondary hover:before:left-0 transition-all ease-linear duration-150 before:transition-all before:ease-linear before:duration-100"
                      }
                    >
                      {item?.title}
                    </NavLink>
            ...
            <div className="block lg:hidden pr-2">
              <ul className="flex items-center gap-x-3">
                ...
                <li className="text-white text-[20px] relative cursor-pointer">
                  <IoReorderThree

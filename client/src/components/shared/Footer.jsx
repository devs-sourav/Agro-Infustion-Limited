          ...
          <Containar>
            <div className=" grid grid-cols-12 gap-y-4 md:gap-4 lg:gap-10">
              ...
              <div className="col-span-12 md:col-span-6 lg:col-span-4 h-auto">
                <Link to={"/"} className="w-[68px] block">
                  <img className="w-full" src={"https://i.ibb.co.com/b2qX9QH/logo.png"} />
                </Link>
                <h2 className="text-xl text-text font-bold mb-3 mt-5">
                  We Are Agro Infusion Limited
                </h2>
                <p className="text-[14px] leading-7 text-gray-600">
                  ...
                  Agricultural Efficiency And Sustainability nd Services That
              ...
              <div className="col-span-12 lg:col-span-4">
                ...
                <iframe className="h-[200px] w-full border-none" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d24548.442709530453!2d90.24166469547629!3d23.848883384302226!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755eb490dba663d%3A0x674035f9196f93f6!2sAgro%20Infusion!5e0!3m2!1sen!2sbd!4v1728377757178!5m2!1sen!2sbd"   allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
              </div>
            </div>
          </Containar>
        </div>
        ...
        <Containar>
          <div className="flex justify-between flex-wrap px-5 lg:px-0 py-5 text-white">
            <p className="text-[12px] sm:text-[14px]">
              Agro Infusion Limited © 2024. All Rights Reserved.
            </p>
            <p className="text-[12px] sm:text-[14px]">
